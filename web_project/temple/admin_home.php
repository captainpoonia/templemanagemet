	...
	<div id="div3" class="fixed">
		<ul>
			...
			<li><a href="">Schedules</a>
			     <ul>
				   <li><a href="http://localhost/web_project/temple/schedule/admin_pooja.php">Pooja</a></li>
				   <li><a href="http://localhost/web_project/temple/schedule/admin_darshan.php">Darshan</a></li>
			     </ul>
			</li>
			<li><a href="http://localhost/web_project/temple/booking/admin_pooja.php"> Booking </a></li>
			...
			<li align="right"> <a href="temple/customer_logout.php"> Log Out</a></li>
		</ul>   
	</div>
<div id="div3" >
