...
else
{
	...
	$sql="insert into booking values('$var4','1')";
	$res=$conn->query($sql);
	//script ->booking done
...
<div id="div6" style="background-color: #d5faaa" >
	<h3 style="margin-top: 40px; font-size: 40px" align="center">Pooja Schedule</h3>
...
$sql = "SELECT pooja_name,pooja_date,pooja_time FROM pooja where pooja_date >'0000-00-00' order by pooja_date ,pooja_time ";
...
?>
		...
		<div id="book" align="center">
			...
			<table >
				...
				<tr ><td></td><td ><input type="submit" name="book_pooja" value="BOOK"></td></tr>
			</table> </form>
		</div>
