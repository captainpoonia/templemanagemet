...
if(isset($_POST['submit']))
{
	...
	$var1=$_POST['name'];
	$var2=$_POST['sex'];
		$sql="update customer set sex='$var2' where cust_name ='$var1' ";
	$res=$conn->query($sql);
}
?>
<html>
...
<form action="#" method="post" style="background-color:  #d5faaa;">
	    <div align="center" >
    	<h3 style="font-size: 40px; margin-bottom: 0px; ">update User</h3><table id="tableid"> 
	  ...
	  <tr><th>Sex  </th> <td><input type="text" name="sex" placeholder="" style="height: 45px; width: 100%;"></td></tr>
	  	  <tr><td colspan="2" align="center"><input type="submit" name="submit" style="height: 45p"</table>
    </div>
</form>
</div>
