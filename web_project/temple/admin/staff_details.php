...
<body>
	...
	<div id="div3" class="fixed" style="background-color: orange;">
		<ul>
			...
			<li align="right"> <a href="staffomer_logout.php"> Log Out</a></li>
		</ul>   
	</div>
<div id="div6" align="center" style="background-color: #d5faaa;" >
	<h3 style="font-size: 40px;">Staff Details</h3>
<table id="tableid">
...
$sql = "SELECT staff_id,staff_name,sex,staff_phno,staff_add FROM staff order by staff_id";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>" .$row["staff_id"]."</td><td>". $row["staff_name"]. "</td><td>". $row["sex"]. "</td><td> " . $row["staff_phno"] . "</td><td>". $row["staff_add"]. "</td></tr>";
    }
} 
