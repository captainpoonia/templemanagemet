...
if(isset($_POST['submit']))
{
	...
	$var2=$_POST['date'];
	$var3=$_POST['time'];
	$sql="insert into darshan values('$var2','$var3')";
	$res=$conn->query($sql);
}
?>
<html>
...
<div id="div6" align="center" style="margin-top: 80px; background-color:  #d5faaa">
	<h3 style="font-size: 40px;">Enter Darshan</h3>
